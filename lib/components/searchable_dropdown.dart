...
class SearchableDropdownTextField<T> extends StatefulWidget {
    ...
    factory SearchableDropdownTextField.create({
        Key key,
        ...
        return (SearchableDropdownTextField._(
            key: key,
            items: items,
            onChanged: onChanged,
            value: value,
...
class _SearchableDropdownState<T> extends State<SearchableDropdownTextField<T>> {
    ...
    void _updateSelectedIndex() {
        if((widget.items == null || widget.items.length == 0) && selectedItems != null) {
            selectedItems.clear();
        }
    ...
    @override
    void didUpdateWidget(SearchableDropdownTextField oldWidget) {
